...
function script_properties()
	...
	obs.obs_properties_add_text(props, "participants_text", "Participants", obs.OBS_TEXT_DEFAULT)
	obs.obs_properties_add_button(props, "start_again_button", "Start again", start_again_button_clicked)
...
function script_defaults(settings)
	obs.obs_data_set_default_string(settings, "participants_text", "Mike, Catherine, Tim, Julia")
end
...
function script_load(settings)
	...
	hotkey_id = obs.obs_hotkey_register_frontend("start_again_timer_thingy", "Start again", start_again)
	local hotkey_save_array = obs.obs_data_get_array(settings, "start_again_hotkey")
